...
var arrowImage;
var arrow;
var ButtonS,ButtonU,ButtonD;
var ButtonSImage, ButtonUImage, ButtonDImage
...
function preload(){
 ...
 c4Image=loadImage("blue_balloon0.png")
  ...
  ButtonUImage=loadImage("ButtonU.jpg")
  ButtonDImage=loadImage("ButtonU.jpg")
  ButtonSImage=loadImage("ButtonS.jpg")
...
function setup() {
  ...
  ButtonS=createSprite(220,340,60,10);
  ButtonS.addImage("ButtonS",ButtonSImage)
  ButtonS.scale=0.2
  ButtonU=createSprite(320,290,10,10);
  ButtonU.addImage("ButtonU",ButtonUImage)
  ButtonU.scale=0.1
  ButtonD=createSprite(320,340,10,10);
  ButtonD.addImage("ButtonD",ButtonDImage)
  ButtonD.scale=0.1
...
function draw() {
 ...
 if(mousePressedOver(ButtonD)){
    bow.velocityY=4;
    arrow.velocityY=4;  
  }
 
  if (mousePressedOver(ButtonS)){
    arrow.velocityX=-10;
  }
